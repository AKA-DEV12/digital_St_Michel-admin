        ...
        <td class="px-6 py-4 text-end">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-3 p-2">
                    <li><a class="dropdown-item small py-2 rounded-2" href="{{ route('admin.registrations.show', $reg->uuid) }}"><i class="fa-solid fa-eye me-2 opacity-100 text-primary"></i> <b>Détails</b></a></li>
