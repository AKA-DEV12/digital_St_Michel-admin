        ...
        <div class="col-lg-4">
            ...
            <div class="rounded-4 p-4 text-white border-0 shadow-lg" style="background: linear-gradient(135deg, #dc143c 0%, #9f1239 100%) !important;">
                <div class="position-relative z-index-1">
                    ...
                    <p class="small opacity-90 mb-4">Consultez notre documentation pour découvrir le guide pratique d’utilisation de la plateforme.</p>
                    <a href="{{ route('admin.documentation') }}" class="btn btn-white btn-sm px-4 rounded-pill fw-bold text-primary" style="background: white !important; border: none !important;">Consulter la documentation</a>
                </div>
            </div>
        </div>
    </div>
